...
<div class="card">
        ...
        <div class="card-body">
            <form class="form-inline" method="post" action="<?php echo site_url('Reports/searchDepartureReport'); ?>">
              ...
              <input type="hidden" name="isArrival" value="0" />
              <input type="hidden" name="isDeparture" value="1" />
...
<div class="card">
        ...
        <div class="card-body">
           <table class="table table-striped table-condensed" id="table_1">
            ...
            <tbody>
                <?php foreach($Departure_reports as $values): 
                echo '<tr>';
