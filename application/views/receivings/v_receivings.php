                ...
                <form id="sale_form" action="">
                    <div class="row">
                        <div class="col-sm-10">
                            ...
                            <div class="col-sm-4">
                                ...
                                <?php echo anchor('#', 'add_new' . ' <i class="fa fa-plus"></i>', ' data-toggle="modal" data-target="#supplierModal"'); ?>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            ...
                            <label class="control-label col-sm-2" for=""><?php echo 'payment' . ' ' . 'method' ?>:</label>
                            <div class="col-sm-4">
                                <select name="payment_acc_code" id="payment_acc_code" class="form-control select2me"></select>
                            </div>

                            <label class="control-label col-sm-2" for="due_date"><?php echo 'due_date' ?>:</label>
                            <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            ...
                            <label class="control-label col-sm-2" for=""><?php echo 'business' . ' ' . 'address' ?>:</label>
                            <div class="col-sm-4">
                            ...
                            <table class="table table-bordered table-striped table-condensed" id="sale_table">
                                <thead class='thead-dark'>
                                    <tr>
                                        ...
                                        <th><?php echo 'Visa' . ' ' . 'No.'; ?></th>
                                        <th><?php echo 'Visa' . ' ' . 'price'; ?></th>
                                        <th><?php echo 'Ticket Supplier'; ?></th>
                                        <th><?php echo 'Ticket' . ' ' . 'price'; ?></th>
                                        <th><?php echo 'Hotel Supplier'; ?></th>
                                        <th><?php echo 'Hotel' . ' ' . 'price'; ?></th>
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="5" rowspan="2">
                                            <a href="#" class="btn btn-info btn-sm add_new" name="add_new"><?php echo 'add_new'; ?></a>
                                    ...
                                    <tr>
                                        <th colspan="5"><?php echo form_submit('', 'save' . ' ' . 'and' . ' ' . 'new', 'id="new" class="btn btn-success"'); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="supplierForm" action="">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3" for="email"><?php echo 'store' . ' ' . 'name'; ?>:</label>
                            <div class="col-sm-9">
        ...
        $(document).ready(function() {
            ...
            $('.add_new').on('click', function(event) {
                ...
                var div = '<tr><td>' + counter + '</td>' +
                    ...
                    '<td width="10%"><input  class="form-control pnr" id="pnr_' + counter + '" name="pnr[]" /></td>' +
                    '<td width="10%"><select  class="form-control visa_supplier_id" id="visasupplierid_' + counter + '" name="visa_supplier_id[]"></select></td>' +
                    ...
                    '<td><input  class="form-control visa_no" id="visano_' + counter + '" name="visa_no[]" /></td>' +
                    '<td class="text-right"><input type="number" class="form-control visa_cost" id="visacost_' + counter + '" name="visa_cost[]" step="0.0001" autocomplete="off">' +
                    '<td><select  class="form-control ticket_supplier_id" id="ticketsupplierid_' + counter + '" name="ticket_supplier_id[]"></select></td>' +
                    '<td class="text-right"><input type="number" class="form-control ticket_cost" id="ticketcost_' + counter + '" name="ticket_cost[]" step="0.0001" autocomplete="off">' +
                    '<td><select  class="form-control hotel_supplier_id" id="hotelsupplierid_' + counter + '" name="hotel_supplier_id[]"></select></td>' +
                    '<td class="text-right"><input type="number" class="form-control hotel_cost" id="hotelcost_' + counter + '" name="hotel_cost[]" step="0.0001" autocomplete="off">' +
                    '<td class="text-right"><input type="number" class="form-control other_cost" id="othercost_' + counter + '" name="other_cost[]" step="0.0001" autocomplete="off">' +
                ...
                $(".qty").on("keyup change", function(e) {
                    ...
                    var price = parseFloat($('#visacost_' + curId).val());
