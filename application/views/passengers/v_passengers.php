                ...
                <table class="table table-bordered table-striped table-sm" id="table_1">
                    ...
                    <tbody>
                        ...
                        foreach ($passengers as $key => $list) {
                            ...
                            <a href="<?php echo site_url('Passengers/delete/' . $list['id']) ?>" onclick="return confirm('Are you sure you want to delete?')" title="Make Inactive"><i class="fa fa-trash-o fa-fw">Delete</i></a>
